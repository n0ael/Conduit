...
Isolator3::Isolator3() noexcept
    : AirwindowsPlugin ("isolator3", "Isolator3", kParameters)
{
}

void Isolator3::resetState() noexcept
{
...
void Isolator3::processStereo (const float* in1, const float* in2,
                               float* out1, float* out2, int sampleFrames) noexcept
{
    ...
    biquadA[biq_freq] = std::pow (isoFreq, (2.0 * std::sqrt (overallscale))) * 0.4999;
    ...
    hiquadA[biq_freq] = std::pow (hisoFreq, (2.0 * std::sqrt (overallscale))) * 0.4999;
    ...
    double K = std::tan (juce::MathConstants<double>::pi * biquadA[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * biquadB[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * biquadC[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * biquadD[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * biquadE[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * biquadF[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * biquadG[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * hiquadA[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * hiquadB[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * hiquadC[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * hiquadD[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * hiquadE[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * hiquadF[biq_freq]);
    ...
    K = std::tan (juce::MathConstants<double>::pi * hiquadG[biq_freq]);
