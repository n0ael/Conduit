 ...
 *
 *  Struktur: "3x3"-Householder-Kaskade (a3*) speist eine Brickwall-FIR
 *  (firBuffer*, 32768 Samples) vor einer "6x6"-Householder-Kaskade (a6*),
 *  dazu eine Prädelay-Line (aZ*, bis 15000 Samples) und Bezier-Undersampling-
 *  Rekonstruktion (bez[]) für den DeRez-Parameter.
 * ======================================== */
...
/** kBeyond — Householder-FDN-Reverb mit Brickwall-FIR-Filter und
    Bezier-Undersampling (Regen/Derez/Filter/EarlyRF/Predelay/Dry-Wet). */
class KBeyond final : public AirwindowsPlugin
{
public:
    enum Params
    {
...
private:
    // Original-Konstanten (39 to 101 ms, 587 seat theater — "3x3"-Kaskade)
    static constexpr int d3A = 250;  static constexpr int d3B = 1174; static constexpr int d3C = 305;
    static constexpr int d3D = 1267; static constexpr int d3E = 1240; static constexpr int d3F = 1387;
    static constexpr int d3G = 1461; static constexpr int d3H = 1448; static constexpr int d3I = 1564;

    // Original-Konstanten (2 to 75 ms, 181 seat club — "6x6"-Kaskade)
    static constexpr int d6A = 2;   static constexpr int d6B = 3;   static constexpr int d6C = 536;
    static constexpr int d6D = 190; static constexpr int d6E = 504; static constexpr int d6F = 609;
    static constexpr int d6G = 8;   static constexpr int d6H = 574; static constexpr int d6I = 558;
    static constexpr int d6J = 516; static constexpr int d6K = 12;  static constexpr int d6L = 13;
    static constexpr int d6M = 488; static constexpr int d6N = 560; static constexpr int d6O = 416;
    static constexpr int d6P = 585; static constexpr int d6Q = 18;  static constexpr int d6R = 19;
    static constexpr int d6S = 495; static constexpr int d6T = 21;  static constexpr int d6U = 30;
    static constexpr int d6V = 578; static constexpr int d6W = 104; static constexpr int d6X = 487;
    static constexpr int d6Y = 157; static constexpr int d6ZA = 27; static constexpr int d6ZB = 280;
    static constexpr int d6ZC = 360; static constexpr int d6ZD = 452; static constexpr int d6ZE = 31;
    static constexpr int d6ZF = 537; static constexpr int d6ZG = 291; static constexpr int d6ZH = 34;
    static constexpr int d6ZI = 483; static constexpr int d6ZJ = 28; static constexpr int d6ZK = 542;
    ...
    enum
    {
        ...
        bez_cycle,
        bez_total
    }; // die Bezier-Kurven-Rekonstruktion fürs Undersampling
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (KBeyond)
};
