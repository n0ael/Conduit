/* ========================================
 *  Console0Channel - Console0Channel.cpp
...
Console0Channel::Console0Channel() noexcept
    : AirwindowsPlugin ("console0channel", "Console0Channel", kParameters)
{
}

void Console0Channel::resetState() noexcept
{
    avgAL = avgAR = avgBL = avgBR = 0.0;
}

void Console0Channel::processStereo (const float* in1, const float* in2,
