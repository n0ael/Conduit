...
Cans::Cans() noexcept
    : AirwindowsPlugin ("cans", "Cans", kParameters)
{
}

void Cans::applyRoomPreset (int clearcoat) noexcept
{
    ...
    {
        case 0:
            shortA = 34;  shortB = 193;  shortC = 255;  shortD = 150;  shortE = 24;  shortF = 204;  shortG = 85;  shortH = 295;
            shortI = 40;  shortJ = 371;  shortK = 370;  shortL = 202;  shortM = 11;  shortN = 431;  shortO = 23;  shortP = 323;
            break; //2 to 30 ms, 32 seat room
        case 1:
            shortA = 32;  shortB = 298;  shortC = 402;  shortD = 161;  shortE = 165;  shortF = 149;  shortG = 43;  shortH = 313;
            shortI = 83;  shortJ = 397;  shortK = 316;  shortL = 315;  shortM = 11;  shortN = 685;  shortO = 16;  shortP = 486;
            break; //3 to 40 ms, 59 seat room
        case 2:
            shortA = 23;  shortB = 357;  shortC = 305;  shortD = 186;  shortE = 104;  shortF = 255;  shortG = 163;  shortH = 147;
            shortI = 56;  shortJ = 480;  shortK = 317;  shortL = 107;  shortM = 11;  shortN = 704;  shortO = 26;  shortP = 543;
            break; //4 to 40 ms, 60 seat room
        case 3:
            shortA = 192;  shortB = 463;  shortC = 420;  shortD = 34;  shortE = 161;  shortF = 426;  shortG = 160;  shortH = 474;
            shortI = 21;  shortJ = 343;  shortK = 296;  shortL = 294;  shortM = 11;  shortN = 987;  shortO = 64;  shortP = 482;
            break; //5 to 51 ms, 94 seat room
        case 4:
        default:
            shortA = 173;  shortB = 587;  shortC = 550;  shortD = 324;  shortE = 165;  shortF = 324;  shortG = 312;  shortH = 574;
            shortI = 100;  shortJ = 793;  shortK = 788;  shortL = 385;  shortM = 11;  shortN = 1008;  shortO = 46;  shortP = 380;
            break; //10 to 67 ms, 177 seat club
    }
    prevClearcoat = clearcoat;
}

void Cans::resetState() noexcept
{
    applyRoomPreset (2); // Default-Room entspricht Original-Konstruktor-Größen (case 2)
...
void Cans::processStereo (const float* in1, const float* in2,
                          float* out1, float* out2, int sampleFrames) noexcept
{
    ...
    if (clearcoat != prevClearcoat)
        applyRoomPreset (clearcoat);

    double derez = 1.0 / overallscale;
    derez = 1.0 / ((int) (1.0 / derez));
    //this hard-locks derez to exact subdivisions of 1.0

    int diffuse = (int) (std::pow ((double) B, 1.618033988749894848204586) * 16);
    double iirAmt = 1.0 - std::pow (1.0 - C, 1.618033988749894848204586);
    double iirExt = iirAmt / overallscale;
    double crossfade = (1.0 - std::pow (1.0 - D, 1.618033988749894848204586));
    double wet = std::pow (E, 1.618033988749894848204586);
